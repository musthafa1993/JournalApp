...
class ReadSingleEntry extends StatelessWidget {
  ...
  const ReadSingleEntry({Key? key, required this.title, required this.date, required this.entry}) : super(key: key);
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text(title,softWrap: true,style: TextStyle(color: Colors.white,
                      fontSize: 30,
                      fontWeight: FontWeight.w600),),
                    ],
                  ),
